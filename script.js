...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Code below will auto work on any tool page if uploadForm and fileInput are present in HTML
  ...
  if (uploadForm) {
    uploadForm.addEventListener('submit', async function(e) {
      ...
      // IMPORTANT: If backend runs on another port or host, update URL accordingly!
      ...
      document.getElementById('message').textContent = result.status === 'success'
